...
export const Employee2 = {
    ...
    in managing Dipsea's direct investment strategy. Eddy has over 25 years of experience in trading, operations, and portfolio risk 
...
export const Employee4 = {
    ...
    desc: `Prior to joining Dipsea Capital in 2019, Mr. Clark researched and managed portfolios of alternative investment strategies since 2003. 
    ...
    Mr. Clark earned an MBA with honors from Columbia Business School and a Bachelor’s in Business Administration, Summa Cum Laude, from John Brown 
    University.`,
...
export const Employee5 = {
    ...
    desc: `At Dipsea Capital, Mr. Rekhtman oversees all aspects of the fund’s operations and compliance. Mr. Rekhtman joined Dipsea in July, 2020 
    ...
    Most recently, Mr. Rekhtman served as an outsourced CFO to private equity and hedge fund managers with investment management consultant 
    ...
    back-office operations. Prior to this, Mr. Rekhtman was a senior fund accountant at Passport Capital managing accounting processes for multiple 
    hedge funds, 40 Act funds, and separate accounts. Mr. Rekhtman began his career at hedge fund Parallax Volatility Advisers as a senior fund 
    accountant with additional responsibilities in compliance and operations. Mr. Rekhtman received his bachelor of science in Corporate Finance and 
...
export const Employee6 = {
    name: 'Cameron Grimes',
    position: 'Trader',
    desc: `Mr. Grimes joined Dipsea Capital in July, 2020 after serving six years as a derivatives trader for CMZ T
    ...
    Chicago Board of Options Exchange. Mr. Grimes earned his bachelor’s degree in Economics from The University of Chicago.`,
