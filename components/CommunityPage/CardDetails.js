export const card1 = {
    head: 'Canal Alliance',
    desc: `Canal Alliance offers immigration legal services, education, career programs, and social services to help Latinx 
    immigrants and their families overcome the barriers to success`,
    link: 'https://canalalliance.org/',
    img: '/Community/Canal-Alliance.png'
};

export const card2 = {
    head: 'Univeristy of California, Davis',
    desc: `The UC Davis College of Biological Sciences is one of three colleges in the country dedicated to the study
